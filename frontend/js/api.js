...
const API = {
  ...
  getCrossroadsItems: (gameId) => apiCall('GET', `/crossroads/items?game_id=${encodeURIComponent(gameId)}`),
  ...
  getCrossroadsLore: (gameId) => apiCall('GET', `/crossroads/lore?game_id=${encodeURIComponent(gameId)}`),
  ...
  getCrossroadsMessages: (gameId) => apiCall('GET', `/crossroads/messages?game_id=${encodeURIComponent(gameId)}`),
