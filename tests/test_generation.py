...
class TestUniverseGeneration:
    def test_generates_correct_number_of_systems(self):
...
class TestShipModel:
    ...
    def test_ship_to_dict_and_back(self):
...
class TestGameState:
    ...
    def test_apply_choice_outcome(self):
    ...
    def test_apply_choice_outcome_clamping(self):
...
class TestDiscoveryModel:
    def test_discovery_to_dict_and_back(self):
    ...
    def test_lore_fragment_to_dict_and_back(self):
