...
EVENT_TEMPLATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "rarity": "uncommon",
        "title": "Ion Storm",
        "flavor": "An electrical storm disrupts your ship's systems. Screens flicker and navigation wavers as the ion storm engulfs your vessel.",
        "choices": [
            {"text": "Power down and drift through", "outcome": "fuel:-5; Powered down and drifted safely through the storm."},
            {"text": "Push through with emergency power", "outcome": "hull:-10; Emergency power pushed through the storm, but electrical damage was sustained."},
            {"text": "Use the storm to recharge capacitors", "outcome": "fuel:10; hull:-5; Recharged some fuel reserves but took minor electrical damage."},
        ],
        "trigger_conditions": {"phenomenon": "nebula"},
    },
    {
        ...
        "flavor": "Your sensors detect a dense cloud of protoplanetary material \u2014 a stellar nursery where new planets are being born. The region is rich with raw elements.",
        "choices": [
            {"text": "Scoop up protoplanetary material", "outcome": "cargo:2; Scooped up valuable protoplanetary material!"},
            {"text": "Study the formation process", "outcome": "credits:80; Gathered valuable scientific data on planetary formation."},
            {"text": "Navigate carefully through the nursery", "outcome": "credits:150; Discovered a hidden rare protoplanet in the nursery!"},
        ],
        "trigger_conditions": {"phenomenon": "nebula"},
    },
    {
        "type": "exploration",
        "rarity": "rare",
        "title": "Precursor Nebula Beacon",
        "flavor": "An ancient signal echoes through the nebula. It's a repeating transmission from a long-dead civilization, encoded in the nebula's gas clouds.",
        "choices": [
            {"text": "Follow the signal to its source", "outcome": "morale:15; Discovered a lore fragment from the precursor signal!"},
            {"text": "Broadcast a response signal", "outcome": "morale:10; The signal echoes into the void. Perhaps someone will hear it."},
            {"text": "Record the signal and move on", "outcome": "credits:60; Recorded the ancient signal for scientific study."},
        ],
        "trigger_conditions": {"phenomenon": "nebula"},
    },
    {
        "type": "hazard",
        "rarity": "uncommon",
        "title": "Pulsar Beam Sweep",
        "flavor": "The pulsar's beam sweeps across your ship. Warning klaxons blare as the intense radiation beam approaches.",
        "choices": [
            {"text": "Raise shields and ride it out", "outcome": "hull:20; Gained Pulsar-Enhanced Shields temporary buff."},
            {"text": "Try to harvest energy from the beam", "outcome": "fuel:15; hull:-5; Harvested energy from the pulsar beam but took radiation damage."},
            {"text": "Flee the beam's path", "outcome": "Safe, but the opportunity passes."},
        ],
    ...
    },
    {
        "type": "discovery",
        "rarity": "uncommon",
        "title": "Pulsar Timing Anomaly",
        "flavor": "The pulsar's normally precise rhythm is irregular, suggesting a hidden gravitational companion. Your science officer is excited by the anomaly.",
        "choices": [
            {"text": "Investigate the anomaly", "outcome": "credits:200; Discovered a hidden neutron star with unique POIs!"},
            {"text": "Log the data for later analysis", "outcome": "credits:75; Scientific data logged for future study."},
            {"text": "Ignore it and continue", "outcome": "The journey continues."},
        ],
        "trigger_conditions": {"phenomenon": "pulsar"},
    },
    {
        ...
        "flavor": "A massive magnetic flare erupts from the pulsar. Your ship's systems flicker and strain under the intense magnetic field.",
        "choices": [
            {"text": "Emergency shutdown of all systems", "outcome": "fuel:-10; Emergency shutdown protected the ship from the magnetic surge."},
            {"text": "Ride the magnetic wave", "outcome": "fuel:20; hull:-15; Rode the magnetic wave and gained energy, but hull took damage."},
            {"text": "Deploy a sensor probe to study the flare", "outcome": "cargo:-1; credits:150; Lost the probe but gained valuable magnetic data."},
        ],
        "trigger_conditions": {"phenomenon": "pulsar"},
    },
    {
        ...
        "flavor": "The two stars align perfectly, creating a rare eclipse. One star passes behind the other, casting the system into an eerie twilight.",
        "choices": [
            {"text": "Study the eclipse", "outcome": "credits:120; Gathered valuable scientific data from the rare eclipse."},
            {"text": "Search for eclipse-watching structures", "outcome": "morale:15; Found an ancient observatory built to watch the eclipses!"},
            {"text": "Use the darkness to move undetected", "outcome": "Safe passage through the system under cover of darkness."},
        ],
    ...
    },
    {
        "type": "discovery",
        "rarity": "common",
        "title": "Lagrange Point Cache",
        "flavor": "A stable Lagrange point between the two stars has accumulated debris over millennia. Your sensors detect metallic signatures among the rocks.",
        "choices": [
            {"text": "Search the debris field thoroughly", "outcome": "cargo:3; Found valuable salvage and artifacts in the debris!"},
            {"text": "Set up a remote sensor array", "outcome": "credits:50; Deployed sensors that will transmit data over time."},
            {"text": "Pass through quickly", "outcome": "Safe passage through the Lagrange point."},
        ],
        "trigger_conditions": {"phenomenon": "binary_star"},
    },
    {
        "type": "exploration",
        "rarity": "uncommon",
        "title": "Tidal Lock World",
        "flavor": "A planet caught between the two stars, tidally locked with one face eternally scorched and the other frozen. The twilight zone between them might harbor unique conditions.",
        "choices": [
            {"text": "Land on the twilight zone", "outcome": "credits:200; Discovered a unique biome with rare discoveries in the twilight zone!"},
            {"text": "Study the planet from orbit", "outcome": "credits:90; Gathered valuable orbital data on the tidal lock world."},
            {"text": "Skip it and move on", "outcome": "The planet fades behind you."},
        ],
        "trigger_conditions": {"phenomenon": "binary_star"},
    },
    {
...
EVENT_COOLDOWNS = {
    ...
    "Asteroid Swarm": 3,
    "Binary Eclipse": 6,
    "Black Market Access": 8,
    "Crew Discovery": 3,
    "Crew Dispute": 8,
    "Crew Illness": 8,
    "Crew Recruitment Offer": 8,
    "Derelict Signal": 6,
    "Derelict Vessel": 3,
